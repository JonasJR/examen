...
landmarks = numpy.loadtxt('/home/jeeenas/ownCloud/PHOTOS/ResultModified.txt', delimiter=',', usecols=range(136))

featuresALL = generateAllFeatures(landmarks)
numpy.savetxt('/home/jeeenas/ownCloud/PHOTOS/ResultModified_ALL.txt', featuresALL, delimiter=',', fmt = '%.04f')
